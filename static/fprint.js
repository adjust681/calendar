...
* This is a javascript only way to fingerprint a user with better than 90% accuracy in as few bytes as possible and no
* cookie storage!

* Special thanks to Valentin Vasilyev for the original fingerprintjs slightly modified and to Open Source Device
* Fingerprinting by Dark Wave Tech for the various identity functions
*/

const gFingerprint = (function () {
    const userFingerprint = {};

    const glbOnError = 'N/A'
    const glbSep = '|';
    ...
    let activeXDetect = function (componentClassID) {
        "use strict";
    ...
    let stripIllegalChars = function (strValue) {
        "use strict";
    ...
    let hashtable_containsKey = function (key) {
        "use strict";
    ...
    let hashtable_get = function (key) {
        "use strict";
    ...
    let hashtable_put = function (key, value) {
        "use strict";
    ...
    let _fingerprint_flash = function () {
        "use strict";
    ...
    let _fingerprint_browser = function () {
        "use strict";
    ...
    let _fingerprint_canvas = function () {
        "use strict";
    ...
    let _fingerprint_connection = function () {
        "use strict";
    ...
    let _fingerprint_cookie = function () {
        "use strict";
        ...
        try {
            bolCookieEnabled = navigator.cookieEnabled;

            //if not IE4+ nor NS6+
            if (typeof navigator.cookieEnabled === "undefined" && !bolCookieEnabled) {
                document.cookie = "testcookie";
                bolCookieEnabled = (document.cookie.indexOf("testcookie") !== -1);
            }
    ...
    let _fingerprint_display = function () {
        "use strict";
    ...
    let _fingerprint_fontsmoothing = function () {
        "use strict";
    ...
    let _fingerprint_fonts = function () {
        "use strict";
    ...
    let _fingerprint_formfields = function () {
        "use strict";
    ...
    let _fingerprint_java = function () {
        "use strict";
    ...
    let _fingerprint_language = function () {
        "use strict";
    ...
    let _fingerprint_latency = function () {
        "use strict";
    ...
    let _fingerprint_silverlight = function () {
        "use strict";
        ...
        try {
            try {
                ...
                if (objPlugin) {
                    ...
                    strSilverlightVersion = glbOnError;
                }
            }
    ...
    let _fingerprint_useragent = function () {
        "use strict";
    ...
    let _fingerprint_timezone = function () {
        "use strict";
    ...
    let _fingerprint_touch = function () {
        "use strict";
    ...
    let _fingerprint_truebrowser = function () {
        "use strict";
    ...
    let _fingerprint_plugins = function () {
        "use strict";
    ...
    userFingerprint.uid = fp.get();

    userFingerprint.test = function () {
        return "out1: " + _fingerprint_flash() +         // N/A
            "\nout2: " + _fingerprint_browser() +        // Chrome 121
            //"\nout3: " + _fingerprint_canvas() +       // many bukoff
            "\nout4: " + _fingerprint_connection() +     // undefined
            "\nout5: " + _fingerprint_cookie() +         // true
            "\nout6: " + _fingerprint_display() +        // 24|1536|864|1474|864
            "\nout7: " + _fingerprint_fontsmoothing() +  // Unknown
            "\nout8: " + _fingerprint_fonts() +          // Arial Black|Arial|Bookman Old ...
            "\nout9: " + _fingerprint_formfields() +     // https://bla-bla.bla/calendar_v2
            "\nout10: " + _fingerprint_java() +          // false
            "\nout11: " + _fingerprint_language() +      // lang=ru-RU|syslang=|userlang=
            "\nout12: " + _fingerprint_latency() +       // 212|4771
            "\nout13: " + _fingerprint_silverlight() +   // N/A
            "\nout14: " + _fingerprint_os() +            // Windows NT 4.0|32 bits
            "\nout15: " + _fingerprint_useragent() +
            "\nout16: " + _fingerprint_timezone() +      // 3
            "\nout17: " + _fingerprint_touch() +         // false
            "\nout18: " + _fingerprint_truebrowser() +   // Safari
            "\nout19: " + _fingerprint_plugins();        // pdf viewer|chrome pdf...
    }

    userFingerprint.test2 = function () {
        return "out: " + _fingerprint_silverlight();
    }
